...
// LogSignerChange is a paid mutator transaction binding the contract method 0x15cbf79c.
//
// Solidity: function logSignerChange(uint256 validatorId, address oldSigner, bytes signerPubkey) returns()
func (_Stakinginfo *StakinginfoTransactor) LogSignerChange(opts *bind.TransactOpts, validatorId *big.Int, oldSigner common.Address, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logSignerChange", validatorId, oldSigner, signerPubkey)
}

// LogSignerChange is a paid mutator transaction binding the contract method 0x15cbf79c.
//
// Solidity: function logSignerChange(uint256 validatorId, address oldSigner, bytes signerPubkey) returns()
func (_Stakinginfo *StakinginfoSession) LogSignerChange(validatorId *big.Int, oldSigner common.Address, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogSignerChange(&_Stakinginfo.TransactOpts, validatorId, oldSigner, signerPubkey)
}

// LogSignerChange is a paid mutator transaction binding the contract method 0x15cbf79c.
//
// Solidity: function logSignerChange(uint256 validatorId, address oldSigner, bytes signerPubkey) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogSignerChange(validatorId *big.Int, oldSigner common.Address, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogSignerChange(&_Stakinginfo.TransactOpts, validatorId, oldSigner, signerPubkey)
}
...
// LogStaked is a paid mutator transaction binding the contract method 0xa54c7b85.
//
// Solidity: function logStaked(bytes signerPubkey, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total) returns()
func (_Stakinginfo *StakinginfoTransactor) LogStaked(opts *bind.TransactOpts, signerPubkey []byte, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logStaked", signerPubkey, validatorId, activationEpoch, amount, total)
}

// LogStaked is a paid mutator transaction binding the contract method 0xa54c7b85.
//
// Solidity: function logStaked(bytes signerPubkey, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total) returns()
func (_Stakinginfo *StakinginfoSession) LogStaked(signerPubkey []byte, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStaked(&_Stakinginfo.TransactOpts, signerPubkey, validatorId, activationEpoch, amount, total)
}

// LogStaked is a paid mutator transaction binding the contract method 0xa54c7b85.
//
// Solidity: function logStaked(bytes signerPubkey, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogStaked(signerPubkey []byte, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStaked(&_Stakinginfo.TransactOpts, signerPubkey, validatorId, activationEpoch, amount, total)
}
...
// FilterSignerChange is a free log retrieval operation binding the contract event 0x442da63889da0a41a10f7614b2f5445bd6a5cd7e73be8056468e169f83a95a39.
//
// Solidity: event SignerChange(uint256 indexed validatorId, address indexed oldSigner, bytes newSignerPubkey)
func (_Stakinginfo *StakinginfoFilterer) FilterSignerChange(opts *bind.FilterOpts, validatorId []*big.Int, oldSigner []common.Address) (*StakinginfoSignerChangeIterator, error) {
	...
	logs, sub, err := _Stakinginfo.contract.FilterLogs(opts, "SignerChange", validatorIdRule, oldSignerRule)
	if err != nil {
		return nil, err
	}
...
// WatchSignerChange is a free log subscription operation binding the contract event 0x442da63889da0a41a10f7614b2f5445bd6a5cd7e73be8056468e169f83a95a39.
//
// Solidity: event SignerChange(uint256 indexed validatorId, address indexed oldSigner, bytes newSignerPubkey)
func (_Stakinginfo *StakinginfoFilterer) WatchSignerChange(opts *bind.WatchOpts, sink chan<- *StakinginfoSignerChange, validatorId []*big.Int, oldSigner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Stakinginfo.contract.WatchLogs(opts, "SignerChange", validatorIdRule, oldSignerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseSignerChange is a log parse operation binding the contract event 0x442da63889da0a41a10f7614b2f5445bd6a5cd7e73be8056468e169f83a95a39.
//
// Solidity: event SignerChange(uint256 indexed validatorId, address indexed oldSigner, bytes newSignerPubkey)
...
// FilterStaked is a free log retrieval operation binding the contract event 0x94bc4e10b2657bb61f49bee6ebee1336217e7e7ecab869b60323354a5396233a.
//
// Solidity: event Staked(uint256 indexed validatorId, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes signerPubkey)
func (_Stakinginfo *StakinginfoFilterer) FilterStaked(opts *bind.FilterOpts, validatorId []*big.Int, activationEpoch []*big.Int) (*StakinginfoStakedIterator, error) {
	...
	logs, sub, err := _Stakinginfo.contract.FilterLogs(opts, "Staked", validatorIdRule, activationEpochRule)
	if err != nil {
		return nil, err
	}
...
// WatchStaked is a free log subscription operation binding the contract event 0x94bc4e10b2657bb61f49bee6ebee1336217e7e7ecab869b60323354a5396233a.
//
// Solidity: event Staked(uint256 indexed validatorId, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes signerPubkey)
func (_Stakinginfo *StakinginfoFilterer) WatchStaked(opts *bind.WatchOpts, sink chan<- *StakinginfoStaked, validatorId []*big.Int, activationEpoch []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Stakinginfo.contract.WatchLogs(opts, "Staked", validatorIdRule, activationEpochRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseStaked is a log parse operation binding the contract event 0x94bc4e10b2657bb61f49bee6ebee1336217e7e7ecab869b60323354a5396233a.
//
// Solidity: event Staked(uint256 indexed validatorId, uint256 indexed activationEpoch, uint256 amount, uint256 total, bytes signerPubkey)
