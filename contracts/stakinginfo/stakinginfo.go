...
//
// Solidity: function logSlashed(uint256 amount, uint256 nonce) returns()
func (_Stakinginfo *StakinginfoTransactor) LogSlashed(opts *bind.TransactOpts, amount *big.Int, nonce *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logSlashed", amount, nonce)
}

// LogSlashed is a paid mutator transaction binding the contract method 0xfb77c94e.
//
// Solidity: function logSlashed(uint256 amount, uint256 nonce) returns()
func (_Stakinginfo *StakinginfoSession) LogSlashed(amount *big.Int, nonce *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogSlashed(&_Stakinginfo.TransactOpts, amount, nonce)
}

// LogSlashed is a paid mutator transaction binding the contract method 0xfb77c94e.
//
// Solidity: function logSlashed(uint256 amount, uint256 nonce) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogSlashed(amount *big.Int, nonce *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogSlashed(&_Stakinginfo.TransactOpts, amount, nonce)
}
...
//
// Solidity: event Slashed(uint256 indexed amount, uint256 indexed nonce)
func (_Stakinginfo *StakinginfoFilterer) FilterSlashed(opts *bind.FilterOpts, amount []*big.Int, nonce []*big.Int) (*StakinginfoSlashedIterator, error) {
	...
	logs, sub, err := _Stakinginfo.contract.FilterLogs(opts, "Slashed", amountRule, nonceRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Slashed(uint256 indexed amount, uint256 indexed nonce)
func (_Stakinginfo *StakinginfoFilterer) WatchSlashed(opts *bind.WatchOpts, sink chan<- *StakinginfoSlashed, amount []*big.Int, nonce []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Stakinginfo.contract.WatchLogs(opts, "Slashed", amountRule, nonceRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
