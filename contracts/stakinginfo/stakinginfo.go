...
//
// Solidity: function getStakerDetails(uint256 validatorId) constant returns(uint256 amount, uint256 rewards, uint256 activationEpoch, uint256 deactivationEpoch, address signer, uint256 _status)
