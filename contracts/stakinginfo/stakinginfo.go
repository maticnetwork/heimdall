...
//
// Solidity: function getStakerDetails(uint256 validatorId) constant returns(uint256 amount, uint256 activationEpoch, uint256 deactivationEpoch, address signer, uint256 _status)
...
// LogClaimFee is a paid mutator transaction binding the contract method 0xcf572fe3.
//
// Solidity: function logClaimFee(uint256 validatorId, uint256 fee) returns()
func (_Stakinginfo *StakinginfoTransactor) LogClaimFee(opts *bind.TransactOpts, validatorId *big.Int, fee *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logClaimFee", validatorId, fee)
}

// LogClaimFee is a paid mutator transaction binding the contract method 0xcf572fe3.
//
// Solidity: function logClaimFee(uint256 validatorId, uint256 fee) returns()
func (_Stakinginfo *StakinginfoSession) LogClaimFee(validatorId *big.Int, fee *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogClaimFee(&_Stakinginfo.TransactOpts, validatorId, fee)
}

// LogClaimFee is a paid mutator transaction binding the contract method 0xcf572fe3.
//
// Solidity: function logClaimFee(uint256 validatorId, uint256 fee) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogClaimFee(validatorId *big.Int, fee *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogClaimFee(&_Stakinginfo.TransactOpts, validatorId, fee)
}
...
// LogDelClaimRewards is a paid mutator transaction binding the contract method 0x0e7fe85f.
//
// Solidity: function logDelClaimRewards(uint256 validatorId, uint256 rewards, uint256 tokens) returns()
func (_Stakinginfo *StakinginfoTransactor) LogDelClaimRewards(opts *bind.TransactOpts, validatorId *big.Int, rewards *big.Int, tokens *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logDelClaimRewards", validatorId, rewards, tokens)
}

// LogDelClaimRewards is a paid mutator transaction binding the contract method 0x0e7fe85f.
//
// Solidity: function logDelClaimRewards(uint256 validatorId, uint256 rewards, uint256 tokens) returns()
func (_Stakinginfo *StakinginfoSession) LogDelClaimRewards(validatorId *big.Int, rewards *big.Int, tokens *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogDelClaimRewards(&_Stakinginfo.TransactOpts, validatorId, rewards, tokens)
}

// LogDelClaimRewards is a paid mutator transaction binding the contract method 0x0e7fe85f.
//
// Solidity: function logDelClaimRewards(uint256 validatorId, uint256 rewards, uint256 tokens) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogDelClaimRewards(validatorId *big.Int, rewards *big.Int, tokens *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogDelClaimRewards(&_Stakinginfo.TransactOpts, validatorId, rewards, tokens)
}
...
func (_Stakinginfo *StakinginfoTransactor) LogJailed(opts *bind.TransactOpts, validatorId *big.Int, exitEpoch *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logJailed", validatorId, exitEpoch)
}
...
func (_Stakinginfo *StakinginfoSession) LogJailed(validatorId *big.Int, exitEpoch *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogJailed(&_Stakinginfo.TransactOpts, validatorId, exitEpoch)
}
...
// LogSignerChange is a paid mutator transaction binding the contract method 0x9a0808e4.
//
// Solidity: function logSignerChange(uint256 validatorId, address oldSigner, address newSigner) returns()
func (_Stakinginfo *StakinginfoTransactor) LogSignerChange(opts *bind.TransactOpts, validatorId *big.Int, oldSigner common.Address, newSigner common.Address) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logSignerChange", validatorId, oldSigner, newSigner)
}
...
func (_Stakinginfo *StakinginfoSession) LogSignerChange(validatorId *big.Int, oldSigner common.Address, newSigner common.Address) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogSignerChange(&_Stakinginfo.TransactOpts, validatorId, oldSigner, newSigner)
}
...
// LogStaked is a paid mutator transaction binding the contract method 0xa970c3b8.
//
// Solidity: function logStaked(address signer, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total) returns()
func (_Stakinginfo *StakinginfoTransactor) LogStaked(opts *bind.TransactOpts, signer common.Address, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logStaked", signer, validatorId, activationEpoch, amount, total)
}

// LogStaked is a paid mutator transaction binding the contract method 0xa970c3b8.
//
// Solidity: function logStaked(address signer, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total) returns()
func (_Stakinginfo *StakinginfoSession) LogStaked(signer common.Address, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStaked(&_Stakinginfo.TransactOpts, signer, validatorId, activationEpoch, amount, total)
}

// LogStaked is a paid mutator transaction binding the contract method 0xa970c3b8.
//
// Solidity: function logStaked(address signer, uint256 validatorId, uint256 activationEpoch, uint256 amount, uint256 total) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogStaked(signer common.Address, validatorId *big.Int, activationEpoch *big.Int, amount *big.Int, total *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogStaked(&_Stakinginfo.TransactOpts, signer, validatorId, activationEpoch, amount, total)
}
...
// LogTopUpFee is a paid mutator transaction binding the contract method 0x4760c00a.
//
// Solidity: function logTopUpFee(uint256 validatorId, uint256 fee) returns()
func (_Stakinginfo *StakinginfoTransactor) LogTopUpFee(opts *bind.TransactOpts, validatorId *big.Int, fee *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.contract.Transact(opts, "logTopUpFee", validatorId, fee)
}

// LogTopUpFee is a paid mutator transaction binding the contract method 0x4760c00a.
//
// Solidity: function logTopUpFee(uint256 validatorId, uint256 fee) returns()
func (_Stakinginfo *StakinginfoSession) LogTopUpFee(validatorId *big.Int, fee *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogTopUpFee(&_Stakinginfo.TransactOpts, validatorId, fee)
}

// LogTopUpFee is a paid mutator transaction binding the contract method 0x4760c00a.
//
// Solidity: function logTopUpFee(uint256 validatorId, uint256 fee) returns()
func (_Stakinginfo *StakinginfoTransactorSession) LogTopUpFee(validatorId *big.Int, fee *big.Int) (*types.Transaction, error) {
	return _Stakinginfo.Contract.LogTopUpFee(&_Stakinginfo.TransactOpts, validatorId, fee)
}
...
// FilterClaimFee is a free log retrieval operation binding the contract event 0x48b06b1a71c95ebd2ca58625da601bd9103a72670daa6d769054365cd81d5e39.
//
// Solidity: event ClaimFee(uint256 indexed validatorId, uint256 indexed fee)
func (_Stakinginfo *StakinginfoFilterer) FilterClaimFee(opts *bind.FilterOpts, validatorId []*big.Int, fee []*big.Int) (*StakinginfoClaimFeeIterator, error) {
	...
	logs, sub, err := _Stakinginfo.contract.FilterLogs(opts, "ClaimFee", validatorIdRule, feeRule)
	if err != nil {
		return nil, err
	}
...
// WatchClaimFee is a free log subscription operation binding the contract event 0x48b06b1a71c95ebd2ca58625da601bd9103a72670daa6d769054365cd81d5e39.
//
// Solidity: event ClaimFee(uint256 indexed validatorId, uint256 indexed fee)
func (_Stakinginfo *StakinginfoFilterer) WatchClaimFee(opts *bind.WatchOpts, sink chan<- *StakinginfoClaimFee, validatorId []*big.Int, fee []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Stakinginfo.contract.WatchLogs(opts, "ClaimFee", validatorIdRule, feeRule)
	if err != nil {
		return nil, err
	}
...
// ParseClaimFee is a log parse operation binding the contract event 0x48b06b1a71c95ebd2ca58625da601bd9103a72670daa6d769054365cd81d5e39.
//
// Solidity: event ClaimFee(uint256 indexed validatorId, uint256 indexed fee)
...
func (_Stakinginfo *StakinginfoFilterer) FilterTopUpFee(opts *bind.FilterOpts, validatorId []*big.Int, fee []*big.Int) (*StakinginfoTopUpFeeIterator, error) {
	...
	logs, sub, err := _Stakinginfo.contract.FilterLogs(opts, "TopUpFee", validatorIdRule, feeRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event TopUpFee(uint256 indexed validatorId, uint256 indexed fee)
func (_Stakinginfo *StakinginfoFilterer) WatchTopUpFee(opts *bind.WatchOpts, sink chan<- *StakinginfoTopUpFee, validatorId []*big.Int, fee []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Stakinginfo.contract.WatchLogs(opts, "TopUpFee", validatorIdRule, feeRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
