...
//
// Solidity: function getStakerDetails(user address) constant returns(uint256, uint256, uint256, address, bytes)
func (_Stakemanager *StakemanagerCaller) GetStakerDetails(opts *bind.CallOpts, user common.Address) (*big.Int, *big.Int, *big.Int, common.Address, []byte, error) {
	var (
		ret0 = new(*big.Int)
		ret1 = new(*big.Int)
		ret2 = new(*big.Int)
...
//
// Solidity: function getStakerDetails(user address) constant returns(uint256, uint256, uint256, address, bytes)
func (_Stakemanager *StakemanagerSession) GetStakerDetails(user common.Address) (*big.Int, *big.Int, *big.Int, common.Address, []byte, error) {
...
//
// Solidity: function getStakerDetails(user address) constant returns(uint256, uint256, uint256, address, bytes)
func (_Stakemanager *StakemanagerCallerSession) GetStakerDetails(user common.Address) (*big.Int, *big.Int, *big.Int, common.Address, []byte, error) {
	return _Stakemanager.Contract.GetStakerDetails(&_Stakemanager.CallOpts, user)
}
...
//
// Solidity: function stakers( address) constant returns(epoch uint256, amount uint256, activationEpoch uint256, deactivationEpoch uint256, signer address, data bytes)
