...
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 heimdallFee, address signer, bool isContract) returns()
func (_Stakemanager *StakemanagerTransactor) ConfirmAuctionBid(opts *bind.TransactOpts, validatorId *big.Int, heimdallFee *big.Int, signer common.Address, isContract bool) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "confirmAuctionBid", validatorId, heimdallFee, signer, isContract)
}

// ConfirmAuctionBid is a paid mutator transaction binding the contract method 0x7d4bd608.
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 heimdallFee, address signer, bool isContract) returns()
func (_Stakemanager *StakemanagerSession) ConfirmAuctionBid(validatorId *big.Int, heimdallFee *big.Int, signer common.Address, isContract bool) (*types.Transaction, error) {
	return _Stakemanager.Contract.ConfirmAuctionBid(&_Stakemanager.TransactOpts, validatorId, heimdallFee, signer, isContract)
}

// ConfirmAuctionBid is a paid mutator transaction binding the contract method 0x7d4bd608.
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 heimdallFee, address signer, bool isContract) returns()
func (_Stakemanager *StakemanagerTransactorSession) ConfirmAuctionBid(validatorId *big.Int, heimdallFee *big.Int, signer common.Address, isContract bool) (*types.Transaction, error) {
	return _Stakemanager.Contract.ConfirmAuctionBid(&_Stakemanager.TransactOpts, validatorId, heimdallFee, signer, isContract)
}
