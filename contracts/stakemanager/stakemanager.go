...
// UpdateValidatorNonce is a paid mutator transaction binding the contract method 0xa9f9e295.
//
// Solidity: function updateValidatorNonce(uint256 validatorId) returns(uint256)
func (_Stakemanager *StakemanagerTransactor) UpdateValidatorNonce(opts *bind.TransactOpts, validatorId *big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "updateValidatorNonce", validatorId)
}

// UpdateValidatorNonce is a paid mutator transaction binding the contract method 0xa9f9e295.
//
// Solidity: function updateValidatorNonce(uint256 validatorId) returns(uint256)
func (_Stakemanager *StakemanagerSession) UpdateValidatorNonce(validatorId *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.UpdateValidatorNonce(&_Stakemanager.TransactOpts, validatorId)
}

// UpdateValidatorNonce is a paid mutator transaction binding the contract method 0xa9f9e295.
//
// Solidity: function updateValidatorNonce(uint256 validatorId) returns(uint256)
func (_Stakemanager *StakemanagerTransactorSession) UpdateValidatorNonce(validatorId *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.UpdateValidatorNonce(&_Stakemanager.TransactOpts, validatorId)
}
