...
1. Send `MsgMilestone`: Here the transaction sender proposes the new checkpoint by sending the start block, end block and the roothash of the new checkpoint
