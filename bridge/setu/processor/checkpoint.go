...
//			"txHash", hmCommonTypes.BytesToHeimdallHash(log.TxHash.Bytes()),
...
//			hmCommonTypes.BytesToHeimdallAddress(event.Proposer.Bytes()),
//			event.Start.Uint64(),
//			event.End.Uint64(),
//			event.Root,
...
//		return err
//	}
//	cp.Logger.Info("Root hash calculated", "rootHash", hmCommonTypes.BytesToHeimdallHash(root))
//	var accountRootHash hmCommonTypes.HeimdallHash
...
//		"start", start,
//		"end", end,
//		"root", hmCommonTypes.BytesToHeimdallHash(root),
...
//		hmCommonTypes.BytesToHeimdallAddress(helper.GetAddress()),
//		start,
//		end,
//		hmCommonTypes.BytesToHeimdallHash(root),
//		accountRootHash,
...
//	cp.Logger.Info("Preparing checkpoint to be pushed on chain", "height", height, "txHash", hmCommonTypes.BytesToHeimdallHash(txHash), "start", start, "end", end)
//	// proof
