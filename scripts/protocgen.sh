...
protoc_gen_gocosmos() {
  if ! grep "github.com/gogo/protobuf => github.com/regen-network/protobuf" go.mod &>/dev/null ; then
    echo -e "\tPlease run this command from somewhere inside the heimdall folder."
    return 1
  fi
...
Mgoogle/protobuf/any.proto=github.com/cosmos/cosmos-sdk/codec/types:. \
  ...
  # get the module name, e.g. from "./proto/heimdall/staking/v1alpha1", extract "data"
...
cp -r github.com/matiknetwork/heimdall/* ./
rm -rf github.com
