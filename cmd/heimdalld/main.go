...
func newApp(logger log.Logger, db dbm.DB, storeTracer io.Writer) abci.Application {
	...
	return app.NewHeimdallApp(logger, db, baseapp.SetMinGasPrices(viper.GetString("minimum-gas-prices")), baseapp.SetPruning(store.NewPruningOptionsFromString(viper.GetString("pruning"))))
}
