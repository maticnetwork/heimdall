...
func (_m *ContractCaller) CurrentChildBlock() (uint64, error) {
	ret := _m.Called()
...
func (_m *ContractCaller) GetBalance(address common.Address) (*big.Int, error) {
...
func (_m *ContractCaller) GetHeaderInfo(headerID uint64) (common.Hash, uint64, uint64, error) {
...
func (_m *ContractCaller) GetValidatorInfo(addr common.Address) (types.Validator, error) {
	ret := _m.Called(addr)
