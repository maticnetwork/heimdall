...
// DecodeSignerUpdateEvent provides a mock function with given fields: tx
func (_m *IContractCaller) DecodeSignerUpdateEvent(receipt *ethTypes.Receipt) (uint64, common.Address, common.Address, error) {
