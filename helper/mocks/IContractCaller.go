...
import big "math/big"
import common "github.com/maticnetwork/bor/common"
import erc20 "github.com/maticnetwork/heimdall/contracts/erc20"
import heimdalltypes "github.com/maticnetwork/heimdall/types"

import mock "github.com/stretchr/testify/mock"
import rootchain "github.com/maticnetwork/heimdall/contracts/rootchain"
import slashmanager "github.com/maticnetwork/heimdall/contracts/slashmanager"
import stakemanager "github.com/maticnetwork/heimdall/contracts/stakemanager"
import stakinginfo "github.com/maticnetwork/heimdall/contracts/stakinginfo"
import statereceiver "github.com/maticnetwork/heimdall/contracts/statereceiver"
import statesender "github.com/maticnetwork/heimdall/contracts/statesender"
import types "github.com/maticnetwork/bor/core/types"
import validatorset "github.com/maticnetwork/heimdall/contracts/validatorset"
...
// CurrentAccountStateRoot provides a mock function with given fields: stakingInfoInstance, stakingInfoAddress
func (_m *IContractCaller) CurrentAccountStateRoot(stakingInfoInstance *stakinginfo.Stakinginfo, stakingInfoAddress common.Address) ([32]byte, error) {
	ret := _m.Called(stakingInfoInstance, stakingInfoAddress)

	var r0 [32]byte
	if rf, ok := ret.Get(0).(func(*stakinginfo.Stakinginfo, common.Address) [32]byte); ok {
		r0 = rf(stakingInfoInstance, stakingInfoAddress)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*stakinginfo.Stakinginfo, common.Address) error); ok {
		r1 = rf(stakingInfoInstance, stakingInfoAddress)
	} else {
		r1 = ret.Error(1)
	}
...
// CurrentHeaderBlock provides a mock function with given fields: rootChainInstance, childBlockInterval, rootchainAddress
func (_m *IContractCaller) CurrentHeaderBlock(rootChainInstance *rootchain.Rootchain, childBlockInterval uint64, rootchainAddress common.Address) (uint64, error) {
	ret := _m.Called(rootChainInstance, childBlockInterval, rootchainAddress)

	var r0 uint64
	if rf, ok := ret.Get(0).(func(*rootchain.Rootchain, uint64, common.Address) uint64); ok {
		r0 = rf(rootChainInstance, childBlockInterval, rootchainAddress)
	} else {
		r0 = ret.Get(0).(uint64)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*rootchain.Rootchain, uint64, common.Address) error); ok {
		r1 = rf(rootChainInstance, childBlockInterval, rootchainAddress)
	} else {
		r1 = ret.Error(1)
	}
...
// GetHeaderInfo provides a mock function with given fields: headerID, rootChainInstance, childBlockInterval, rootchainAddress
func (_m *IContractCaller) GetHeaderInfo(headerID uint64, rootChainInstance *rootchain.Rootchain, childBlockInterval uint64, rootchainAddress common.Address) (common.Hash, uint64, uint64, uint64, heimdalltypes.HeimdallAddress, error) {
	ret := _m.Called(headerID, rootChainInstance, childBlockInterval, rootchainAddress)

	var r0 common.Hash
	if rf, ok := ret.Get(0).(func(uint64, *rootchain.Rootchain, uint64, common.Address) common.Hash); ok {
		r0 = rf(headerID, rootChainInstance, childBlockInterval, rootchainAddress)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 uint64
	if rf, ok := ret.Get(1).(func(uint64, *rootchain.Rootchain, uint64, common.Address) uint64); ok {
		r1 = rf(headerID, rootChainInstance, childBlockInterval, rootchainAddress)
	} else {
		r1 = ret.Get(1).(uint64)
	}

	var r2 uint64
	if rf, ok := ret.Get(2).(func(uint64, *rootchain.Rootchain, uint64, common.Address) uint64); ok {
		r2 = rf(headerID, rootChainInstance, childBlockInterval, rootchainAddress)
	} else {
		r2 = ret.Get(2).(uint64)
	}

	var r3 uint64
	if rf, ok := ret.Get(3).(func(uint64, *rootchain.Rootchain, uint64, common.Address) uint64); ok {
		r3 = rf(headerID, rootChainInstance, childBlockInterval, rootchainAddress)
	} else {
		r3 = ret.Get(3).(uint64)
	}

	var r4 heimdalltypes.HeimdallAddress
	if rf, ok := ret.Get(4).(func(uint64, *rootchain.Rootchain, uint64, common.Address) heimdalltypes.HeimdallAddress); ok {
		r4 = rf(headerID, rootChainInstance, childBlockInterval, rootchainAddress)
	} else {
		if ret.Get(4) != nil {
	...
	var r5 error
	if rf, ok := ret.Get(5).(func(uint64, *rootchain.Rootchain, uint64, common.Address) error); ok {
		r5 = rf(headerID, rootChainInstance, childBlockInterval, rootchainAddress)
	} else {
		r5 = ret.Error(5)
	}
...
// GetLastChildBlock provides a mock function with given fields: rootChainInstance, rootchainAddress
func (_m *IContractCaller) GetLastChildBlock(rootChainInstance *rootchain.Rootchain, rootchainAddress common.Address) (uint64, error) {
	ret := _m.Called(rootChainInstance, rootchainAddress)

	var r0 uint64
	if rf, ok := ret.Get(0).(func(*rootchain.Rootchain, common.Address) uint64); ok {
		r0 = rf(rootChainInstance, rootchainAddress)
	} else {
		r0 = ret.Get(0).(uint64)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*rootchain.Rootchain, common.Address) error); ok {
		r1 = rf(rootChainInstance, rootchainAddress)
	} else {
		r1 = ret.Error(1)
	}
