...
func InitHeimdallConfigWith(homeDir string, heimdallConfigFileFromFLag string) {
	...
	case MainChain:
		...
		milestoneHardForkHeight = 8664000 //Fixme:Change the value
		milestoneBorBlockHeight = 0       //Fixme:Change the value
	case MumbaiChain:
		newSelectionAlgoHeight = 282500
		spanOverrideHeight = 10205000
		milestoneHardForkHeight = 10205000 //Fixme:Change the value
		milestoneBorBlockHeight = 0        //Fixme:Change the value
	default:
		newSelectionAlgoHeight = 0
		spanOverrideHeight = 0
		milestoneHardForkHeight = 12000
		milestoneBorBlockHeight = 1920 //Fixme:Change the value
	}
}
