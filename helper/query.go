...
func QueryTxsByEvents(cliCtx cosmosContext.Context, tags []string, page, limit int) (*sdk.SearchTxsResult, error) {
	if len(tags) == 0 {
...
func QueryTx(cliCtx cosmosContext.Context, hashHexStr string) (sdk.TxResponse, error) {
