...
// Setup initializes a new HeimdallApp. A Nop logger is set in HeimdallApp.
...
// SetupWithGenesisValSet initializes a new HeimdallApp with a validator set and genesis accounts
// that also act as delegators. For simplicity, each validator is bonded with a delegation
// of one consensus engine unit (10^6) in the default token of the HeimdallApp from first genesis
// account. A Nop logger is set in HeimdallApp.
...
// SetupWithGenesisAccounts initializes a new HeimdallApp with the provided genesis
...
// AddTestAddrsFromPubKeys adds the addresses into the HeimdallApp providing only the public keys.
...
func AddTestAddrs(app *HeimdallApp, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
...
func addTestAddrs(app *HeimdallApp, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
...
// saveAccount saves the provided account into the HeimdallApp with balance based on initCoins.
func saveAccount(app *HeimdallApp, ctx sdk.Context, addr sdk.AccAddress, initCoins sdk.Coins) {
