...
func TestSelectNextProducers(t *testing.T) {
	testcases := []producerSelectionTestCase{
		...
		producerSelectionTestCase{"0x8f5bab218b6bb34476f51ca588e9f4553a3a7ce5e13a66c660a5283e97e9a85a", 4, 4, 1},
		producerSelectionTestCase{"0xe09cc356df20c7a2dd38cb85b680a16ec29bd8b3e1ecc1b20f2e5603d5e7ee85", 4, 4, 1},
	}
	...
	for i, testcase := range testcases {
		...
		producers, slots := getSelectedValidtorsFromIDs(validators, producerIds)
...
func getSelectedValidtorsFromIDs(validators []hmTypes.Validator, producerIds []uint64) ([]hmTypes.Validator, int64) {
