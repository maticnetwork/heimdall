...
2. Notice that Prometheus datasource is added and clik on the same
...
3. Change the HTTP url to http://host_ip:9090 and save. Post sucess message, go to grafana home
