...
func MarshallValSlashingInfo(cdc *codec.LegacyAmino, valSlashingInfo ValidatorSlashingInfo) (bz []byte, err error) {
...
func UnmarshallValSlashingInfo(cdc *codec.LegacyAmino, value []byte) (ValidatorSlashingInfo, error) {
