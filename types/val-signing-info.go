...
func MarshallValSigningInfo(cdc *codec.AminoCodec, valSigningInfo ValidatorSigningInfo) (bz []byte, err error) {
...
func UnmarshallValSigningInfo(cdc *codec.AminoCodec, value []byte) (ValidatorSigningInfo, error) {
