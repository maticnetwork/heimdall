...
// source: heimdall/base/v1beta1/validator.proto
...
func (ValidatorID) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b9f43f7bbf4e6390, []int{0}
}
...
func (*Validator) Descriptor() ([]byte, []int) {
	return fileDescriptor_b9f43f7bbf4e6390, []int{1}
}
...
func (*MinimalVal) Descriptor() ([]byte, []int) {
	return fileDescriptor_b9f43f7bbf4e6390, []int{2}
}
...
func init() {
	proto.RegisterFile("heimdall/base/v1beta1/validator.proto", fileDescriptor_b9f43f7bbf4e6390)
}

var fileDescriptor_b9f43f7bbf4e6390 = []byte{
	// 580 bytes of a gzipped FileDescriptorProto
	,
}
