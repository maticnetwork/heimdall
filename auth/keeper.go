...
func NewAccountKeeper(
	cdc *codec.Codec, key sdk.StoreKey, paramstore params.Subspace, proto func() authTypes.Account,
) AccountKeeper {
...
func (ak AccountKeeper) SetParams(ctx sdk.Context, params authTypes.Params) {
	ak.paramSubspace.SetParamSet(ctx, &params)
}

// GetParams gets the auth module's parameters.
func (ak AccountKeeper) GetParams(ctx sdk.Context) (params authTypes.Params) {
