...
// source: heimdall/gov/v1beta1/gov.proto
...
func (VoteOption) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{0}
}
...
func (ProposalStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{1}
}
...
func (m *TxProposal) Reset()         { *m = TxProposal{} }
func (m *TxProposal) String() string { return proto.CompactTextString(m) }
func (*TxProposal) ProtoMessage()    {}
func (*TxProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{1}
}
func (m *TxProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TxProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TxProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TxProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TxProposal.Merge(m, src)
}
func (m *TxProposal) XXX_Size() int {
	return m.Size()
}
func (m *TxProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_TxProposal.DiscardUnknown(m)
}

var xxx_messageInfo_TxProposal proto.InternalMessageInfo
...
func (*Proposer) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{2}
}
...
type Deposit struct {
	ProposalId uint64                                   `protobuf:"varint,1,opt,name=proposal_id,json=proposalId,proto3" json:"proposal_id,omitempty" yaml:"proposal_id"`
	Depositor  types.ValidatorID                        `protobuf:"varint,2,opt,name=depositor,proto3,enum=heimdall.types.ValidatorID" json:"depositor,omitempty"`
...
func (*Deposit) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{3}
}
...
type Proposal struct {
	...
	Status           ProposalStatus                           `protobuf:"varint,3,opt,name=status,proto3,enum=heimdall.gov.v1beta1.ProposalStatus" json:"status,omitempty" yaml:"proposal_status"`
...
func (*Proposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{4}
}
...
func (*TallyResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{5}
}
...
type Vote struct {
	ProposalId uint64            `protobuf:"varint,1,opt,name=proposal_id,json=proposalId,proto3" json:"proposal_id,omitempty" yaml:"proposal_id"`
	Voter      types.ValidatorID `protobuf:"varint,2,opt,name=voter,proto3,enum=heimdall.types.ValidatorID" json:"voter,omitempty"`
...
func (*Vote) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{6}
}
...
func (*DepositParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{7}
}
...
func (*VotingParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{8}
}
...
func (*TallyParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_b05184fafe5f9286, []int{9}
}
...
func init() {
	proto.RegisterEnum("heimdall.gov.v1beta1.VoteOption", VoteOption_name, VoteOption_value)
	proto.RegisterEnum("heimdall.gov.v1beta1.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*TextProposal)(nil), "heimdall.gov.v1beta1.TextProposal")
	proto.RegisterType((*TxProposal)(nil), "heimdall.gov.v1beta1.TxProposal")
	proto.RegisterType((*Proposer)(nil), "heimdall.gov.v1beta1.Proposer")
	proto.RegisterType((*Deposit)(nil), "heimdall.gov.v1beta1.Deposit")
	proto.RegisterType((*Proposal)(nil), "heimdall.gov.v1beta1.Proposal")
	proto.RegisterType((*TallyResult)(nil), "heimdall.gov.v1beta1.TallyResult")
	proto.RegisterType((*Vote)(nil), "heimdall.gov.v1beta1.Vote")
	proto.RegisterType((*DepositParams)(nil), "heimdall.gov.v1beta1.DepositParams")
	proto.RegisterType((*VotingParams)(nil), "heimdall.gov.v1beta1.VotingParams")
	proto.RegisterType((*TallyParams)(nil), "heimdall.gov.v1beta1.TallyParams")
}

func init() { proto.RegisterFile("heimdall/gov/v1beta1/gov.proto", fileDescriptor_b05184fafe5f9286) }

var fileDescriptor_b05184fafe5f9286 = []byte{
	// 1464 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *TxProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TxProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TxProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Type) > 0 {
		i -= len(m.Type)
		copy(dAtA[i:], m.Type)
		i = encodeVarintGov(dAtA, i, uint64(len(m.Type)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Description) > 0 {
...
func (m *Deposit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Depositor != 0 {
		i = encodeVarintGov(dAtA, i, uint64(m.Depositor))
		i--
		dAtA[i] = 0x10
	}
	if m.ProposalId != 0 {
...
func (m *Vote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Voter != 0 {
		i = encodeVarintGov(dAtA, i, uint64(m.Voter))
		i--
		dAtA[i] = 0x10
	}
	if m.ProposalId != 0 {
...
func (m *TxProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TxProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TxProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Depositor |= types.ValidatorID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Voter |= types.ValidatorID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
