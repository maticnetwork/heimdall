...
import (
	...
	// github_com_maticnetwork_heimdall_x_gov_types "github.com/maticnetwork/heimdall/x/gov/types"
...
type Deposit struct {
	...
	Amount     Coins `protobuf:"bytes,3,rep,name=amount,proto3,castrepeated=github.com/maticnetwork/heimdall/x/gov/types.Coins" json:"amount"`
}
...
type Proposal struct {
	...
	TotalDeposit     Coins `protobuf:"bytes,7,rep,name=total_deposit,json=totalDeposit,proto3,castrepeated=github.com/maticnetwork/heimdall/x/gov/types.Coins" json:"total_deposit" yaml:"total_deposit"`
...
type DepositParams struct {
	...
	MinDeposit Coins `protobuf:"bytes,1,rep,name=min_deposit,json=minDeposit,proto3,castrepeated=github.com/maticnetwork/heimdall/x/gov/types.Coins" json:"min_deposit,omitempty" yaml:"min_deposit"`
...
var fileDescriptor_20c0650dfa04283d = []byte{
	...
	,
}
