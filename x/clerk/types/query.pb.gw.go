...
var (
	pattern_Query_Record_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"heimdall", "clerk", "v1beta1", "records", "record_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
